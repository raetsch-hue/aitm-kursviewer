...
> Original online: <https://huggingface.co/learn/mcp-course/unit1/hf-mcp-server> · Quelltext: `AI_Course/mcp-course/units/unit1/hf-mcp-server.mdx`
...
![MCP Settings Example](../AI_Course/mcp-course/bilder/huggingface.co_datasets_huggingface_documentation-images_resolve_main_hf-mcp-settings.png)
